...
public class PrivatePDFGenerator {
    public static byte[] generateReceiptPDF(PrivateOrder privateOrder) {
        try (PDDocument document = new PDDocument()) {
            ...
            try (PDPageContentStream contentStream = new PDPageContentStream(document, page)) {
                ...
                contentStream.showText("Event: " + privateOrder.getEventType());
                contentStream.endText();
                ...
                contentStream.setNonStrokingColor(Color.BLACK);
                contentStream.newLineAtOffset(100, detailsY);
                contentStream.showText("Venue: " + privateOrder.getVenueName());
                contentStream.endText();
                ...
                contentStream.setFont(PDType1Font.HELVETICA, 30);
                contentStream.newLineAtOffset(100, detailsY);
                contentStream.showText("State: " + privateOrder.getState());
                contentStream.endText();

                detailsY -= lineSpacing;
                Date eventDate = privateOrder.getEventDate();
                ...
                contentStream.setFont(PDType1Font.HELVETICA, 30);
                contentStream.newLineAtOffset(100, detailsY);
                contentStream.showText("Caterer: " + privateOrder.getCaterer());
                contentStream.endText();
                detailsY -= lineSpacing;
                ...
                contentStream.setFont(PDType1Font.HELVETICA, 30);
                contentStream.newLineAtOffset(100, detailsY);
                contentStream.showText("Designer: " + privateOrder.getDesignService());
                contentStream.endText();
                detailsY -= lineSpacing;
                ...
                contentStream.setFont(PDType1Font.HELVETICA, 30);
                contentStream.newLineAtOffset(100, detailsY);
                contentStream.showText("Media: " + privateOrder.getMediaService());
                contentStream.endText();
                ...
                contentStream.setFont(PDType1Font.HELVETICA, 30);
                contentStream.newLineAtOffset(100, detailsY);
                contentStream.showText("Total Price Paid: " + privateOrder.getTotalPrice());
                contentStream.endText();
    ...
    private static void drawWatermark(PDPageContentStream contentStream, PDPage page) throws IOException {
        ...
        float offsetY = pageHeight / 2 - 230;
