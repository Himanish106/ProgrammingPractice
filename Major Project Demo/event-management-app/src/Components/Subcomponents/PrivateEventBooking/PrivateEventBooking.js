  ...
  return (
    <section className="pricing">
      ...
      <div className="private-form">
        <h3>Want to Book Your Own Event? Fill the Details Below</h3>
          <form className="private-event-form">
            ...
            {selectedVenue && (
              <div className="venue-details">
                ...
                <div className="venueCapacitydiv">
                ...
                <div className="venueLocationdiv">
          ...
          {selectedVenue && (
            <div className="submit-btn">
              <button type="submit" className="btn">Pay Rs: {totalPrice}</button>
            </div>
          )}
        </div>
        </div>
